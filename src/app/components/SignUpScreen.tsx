      ...
      <div className="flex flex-col px-7 pt-4 pb-10">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            ...
            <div className="flex gap-2 mt-2">
              ...
              >
                ...
                />
                {idChecked && <CheckCircle2 size={18} color="#25bb36ff" />}
              </div>
              <button
            ...
            {idChecked && (
              <p style={{ fontSize: 12, color: '#25bb36ff', marginTop: 6 }}>
                사용 가능한 아이디예요!
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {pwConfirm && pw && (
              <p style={{ fontSize: 12, marginTop: 6, color: pw === pwConfirm ? '#25bb36ff' : '#d4183d' }}>
